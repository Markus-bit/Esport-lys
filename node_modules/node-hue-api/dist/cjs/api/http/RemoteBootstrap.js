...
class RemoteBootstrap {
    ...
    _getRemoteApi(username, timeout) {
        ...
        }, transport = new Transport_1.Transport(HttpClientFetch_1.create(clientConfig), this.rateLimits.transportRateLimit, username), api = new Api_1.Api(config, transport, this.rateLimits, self.remoteApi);
