...
exports.SensorCondition = void 0;
...
class SensorCondition {
    ...
    //TODO
    _setOperator(value) {
        this._operator = (0, operators_1.getOperator)(value);
    }
    //TODO
...
function validateSensorAttribute(sensor, attributeName) {
    ...
    if (allAttributes.indexOf(attributeName) > -1) {
        ...
        throw new HueBridgeModelError_1.HueBridgeModelError(`Attribute '${attributeName}' not found in sensor attributes, ${JSON.stringify(allAttributes)}`);
    }
}
